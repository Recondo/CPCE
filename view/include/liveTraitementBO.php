				...
				include 'index.php';
					...
					if ($bdd == true) {
						...
						$query = $bdd->prepare("INSERT INTO video_live (url_video_live, url_modif, titre_video_live, description_video_live, id_utilisateur) values (:url_video_live, :url_modif, :titre_video_live, :description_video_live, :id_utilisateur)");
