...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 20 Octobre 2017 à 11:06
...
CREATE TABLE `image_programme` (
  ...
  `url_image_programme` varchar(255) DEFAULT NULL,
  `id_utilisateur` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Contenu de la table `image_programme`
--

INSERT INTO `image_programme` (`id_image_programme`, `url_image_programme`, `id_utilisateur`) VALUES
(1, 'https://www.google.fr/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwiG9a-h_P7WAhVJ7BQKHdeUCaIQjRwIBw&url=https%3A%2F%2Ftwitter.com%2Fhashtag%2Flipatatorn&psig=AOvVaw3pJhUgDPxm1YXVe28Me6De&ust=1508580988342786', 1);
...
CREATE TABLE `photo_temoignage` (
  ...
  `url_photo_temoignage` varchar(255) DEFAULT NULL,
...
--
-- Contenu de la table `photo_temoignage`
--

INSERT INTO `photo_temoignage` (`id_photo_temoignage`, `url_photo_temoignage`, `titre_photo`, `description_photo_temoignage`, `id_utilisateur`) VALUES
(1, 'media/img/groupe.jpg', 'fesfsf', 'gdtrghfg', 1);
...
--
-- Contenu de la table `texte_accueil`
--

INSERT INTO `texte_accueil` (`id_texte_accueil`, `contenu_texte_accueil`, `id_utilisateur`) VALUES
(1, 'uiygfthj', 1);
...
(1, 'admin', 'dc76e9f0c0006e8f919e0c515c66dbba3982f785', 'k');
...
CREATE TABLE `video_live` (
  ...
  `url_modif` varchar(255) DEFAULT NULL,
...
(2, 'https://www.youtube.com/watch?v=wBib6YO1md0', 'https://www.youtube.com/embed/wBib6YO1md0', 'qsdqsd', 'hfjgj', 1);
...
--
ALTER TABLE `image_programme`
  MODIFY `id_image_programme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `photo_temoignage`
--
ALTER TABLE `photo_temoignage`
  MODIFY `id_photo_temoignage` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `texte_accueil`
--
ALTER TABLE `texte_accueil`
  MODIFY `id_texte_accueil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `texte_programme`
--
ALTER TABLE `texte_programme`
  MODIFY `id_texte_programme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `video_live`
  MODIFY `id_video_live` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
